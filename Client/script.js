...
function populateFormWithDigiLockerData(data) {
  ...
  document.getElementById('account-form').addEventListener('submit', async function (e) {
    ...
    const userData = {
      ...
      legalName: form['legal-name'].value,
      age: parseInt(form.age.value),
      gender: form.gender.value,
      email: form.email.value,
      address: form.address.value,
      panNumber: form['pan-number'].value,
      panName: form['pan-name'].value,
      accountNumber: form['account-number'].value,
      confirmAccountNumber: form['confirm-account-number'].value,
      accountHolderName: form['account-holder-name'].value,
      bankName: form['bank-name'].value,
      ifscCode: form['ifsc-code'].value,
      branchName: form['branch-name'].value,
      accountType: form['account-type'].value,
      identityProofType: form['identity-proof-type'].value,
      citizenship: form.citizenship.checked,
